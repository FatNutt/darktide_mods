...
â”œâ”€â”€ better_buff_management.mod                            # Mod metadata for Darktide Mod Loader (DON'T CHANGE)
â””â”€â”€ scripts/
    â””â”€â”€ mods/
        â””â”€â”€ better_buff_management/
            â”œâ”€â”€ better_buff_management.lua                # Main entry point, sets up mod, hooks, and UI
            â”œâ”€â”€ better_buff_management_data.lua           # Mod configuration for loading via Darktide Mod Framework
            â”œâ”€â”€ better_buff_management_localization.lua   # Localization strings (UI text, etc.)
            â”œâ”€â”€ hud/
            â”‚   â”œâ”€â”€ hud_element_buff_bar.lua              # Core logic for custom buff bar UI element (The Darktide source code component)
            â”‚   â”œâ”€â”€ hud_element_buff_bar_definitions.lua  # Definitions for how buff bars look/behave (Usefule for changing source code variables)
            â”‚   â””â”€â”€ hud_element_buff_bar_settings.lua     # Hardcoded settings for custom buff bar
            â”œâ”€â”€ models/
            â”‚   â”œâ”€â”€ buff_data.lua                         # Data model for buffs (structure, properties)
            â”‚   â””â”€â”€ search_item.lua                       # Model for tracking buff selection in ImGui
            â”œâ”€â”€ ui/
            â”‚   â”œâ”€â”€ settings.lua                          # Some hardcoded values
            â”‚   â”œâ”€â”€ window.lua                            # Main settings window for the mod (This is the entrypoint for ImGui stuff)
            â”‚   â””â”€â”€ components/
            â”‚       â”œâ”€â”€ base_buff_component.lua           # Base ImGui component for displaying a buff
            â”‚       â”œâ”€â”€ base_component.lua                # Base class for ImGui components
            â”‚       â”œâ”€â”€ buff_bars_component.lua           # ImGui component for managing/displaying buff bars
            â”‚       â”œâ”€â”€ search_component.lua              # ImGui for searching buffs
            â”‚       â””â”€â”€ settings_component.lua            # ImGui for settings controls
            â””â”€â”€ utilities/
                â”œâ”€â”€ debug.lua                             # Debugging helpers/logging
                â”œâ”€â”€ global.lua                            # Global variables/utilities
                â”œâ”€â”€ imgui.lua                             # ImGui UI helpers
                â”œâ”€â”€ mod.lua                               # Mod loader helpers
